...
void Titlepng::Init()
{
	...
	vertex[1].Position = XMFLOAT3(1920.0f, 0.0f, 0.0f);
	vertex[1].Normal = XMFLOAT3(0.0f, 0.0f, 0.0f);
	vertex[1].Diffuse = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[1].TexCoord = XMFLOAT2(1.0f, 0.0f);

	vertex[2].Position = XMFLOAT3(0.0f, 1080.0f, 0.0f);
	vertex[2].Normal = XMFLOAT3(0.0f, 0.0f, 0.0f);
	vertex[2].Diffuse = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[2].TexCoord = XMFLOAT2(0.0f, 1.0f);

	vertex[3].Position = XMFLOAT3(1920.0f, 1080.0f, 0.0f);
	...
	m_BGM->Load("asset\\audio\\huyunagi.wav");
	m_BGM->Play(true);
}

void Titlepng::Uninit()
{
	m_BGM->Uninit();
	delete m_BGM;
