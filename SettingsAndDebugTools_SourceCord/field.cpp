...
void Field::Init()
{
	...
	//CreateShaderResourceView(Renderer::GetDevice(), mipChain.GetImages(), mipChain.GetImageCount(), mipChain.GetMetadata(), &m_Texture);
	//assert(m_Texture);
	...
	LoadFromDDSFile(L"asset\\texture\\field.dds", DDS_FLAGS_NONE, &metadata, image);
